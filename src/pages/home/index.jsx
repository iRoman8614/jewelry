...
const paralaxSet1 = [
    ...
    { id: 1, type: 'image', src: paralax1, alt: '', top: '9%', left: '65%', width: '22%', zIndex: 1, speed: -10 },
    { id: 2, type: 'image', src: paralax2, alt: '', top: '20%', left: '20%', width: '20%', zIndex: 3, speed: 5 },
    { id: 3, type: 'image', src: paralax3, alt: '', top: '40%', left: '55%', width: '24%', zIndex: 2, speed: -5 },
    { id: 4, type: 'image', src: paralax4, alt: '', top: '55%', left: '7%', width: '33%', zIndex: 4, speed: 20 },
...
const paralaxSet2 = [
    ...
    {id: 8, type: 'image', src: paralax7, alt: '', top: '14%', left: '20%', width: '26%', zIndex: 1, speed: -8},
    {id: 9, type: 'image', src: paralax9, alt: '', top: '17%', left: '65%', width: '18%', zIndex: 3, speed: 5},
    {id: 10, type: 'image', src: paralax24, alt: '', top: '28%', left: '10%', width: '30%', zIndex: 3, speed: -12},
    ...
    {id: 14, type: 'image', src: paralax11, alt: '', top: '54%', left: '65%', width: '18%', zIndex: 6, speed: 10},
...
const paralaxSet3 = [
    ...
    {id: 21, type: 'image', src: paralax22, alt: '', top: '24%', left: '62%', width: '27%', zIndex: 2, speed: -4},
    {id: 22, type: 'image', src: paralax17, alt: '', top: '30%', left: '18%', width: '24%', zIndex: 3, speed: 5},
    {id: 23, type: 'image', src: paralax16, alt: '', top: '39%', left: '50%', width: '30%', zIndex: 2, speed: -4},
    {id: 24, type: 'text', title: 'Custom', content: 'Explore the simple yet striking jewelry by 27jwlr. This work has earned accolades from respected design organizations including Adobe, AIGA, and Étapes, and has been featured on platforms like Muzli. Critics have praised his creations as “beautiful and inspired” and “vertigo-inducing,” celebrating them as pure design excellence.', top: '50%', left: '10%', width: '60%', zIndex: 5, speed: 3},
    {id: 25, type: 'image', src: paralax18, alt: '', top: '59%', left: '70%', width: '15%', zIndex: 6, speed: 10},
    {id: 26, type: 'text', content: 'WE ENVISION', top: '66%', left: '60%', width: '20%', zIndex: 100, speed: 2},
    {id: 27, type: 'image', src: paralax19, alt: '', top: '72%', left: '12%', width: '26%', zIndex: 1, speed: -6},
    {id: 28, type: 'text', content: 'FORM', top: '78%', left: '40%', width: '20%', zIndex: 10, speed: -6},
    {id: 29, type: 'image', src: paralax20, alt: '', top: '88%', left: '60%', width: '24%', zIndex: 7, speed: 7},
    {id: 30, type: 'text', content: 'AND CREATE', top: '90%', left: '45%', width: '20%', zIndex: 10, speed: 2},
...
export const HomePage = () => {
    ...
    useEffect(() => {
        ...
        if (hash) {
            const anchorId = hash.substring(hash.lastIndexOf('#') + 1);
            if (anchorId) {
                const element = document.getElementById(anchorId);
                if (element) {
                    const timer = setTimeout(() => {
                        console.log(`Прокрутка к элементу с id: ${anchorId}`);
                        element.scrollIntoView({ behavior: 'smooth', block: 'start' });
                    }, 300);
                    return () => clearTimeout(timer);
                } else {
                    console.warn(`Элемент с id="${anchorId}" не найден для прокрутки.`);
                }
            }
        }
    }, [location.hash]);
    ...
    return(
        <>
            ...
            <main className={styles.root}>
                ...
                <div id="custom" />
                <div>
                    <img className={styles.lightnings} src={lightnings} />
                </div>
            </main>
            <footer>
                <div>
                    <div className={styles.footerContent}>
                        <img className={styles.image} src={footerImg1} />
                        <img className={styles.image2} src={footerImg2} />
                    </div>
                ...
                <div className={styles.footerLine}>
                    <div className={styles.links}>
                        ...
                        <div>27jwlr@service.com</div>
                        <div>@27jwlr</div>
                        <div>Phone number</div>
                    </div>
                    <div className={styles.msk}>moscow-spb</div>
                </div>
                <div className={styles.powered}>powered by scamdevs 2025</div>
            </footer>
        </>
    )
}